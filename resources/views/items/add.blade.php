       ...
       <div class="panel panel-primary">
			...
			<input type="text" class="form-control border-input" name="name" required>
				...
				<fieldset class="form-group">
					...
					<input type="text" value="0" name="purchase_price"  class="form-control border-input" id="formGroupExampleInput2" required>
				</fieldset>

				<fieldset class="form-group">
					<label for="formGroupExampleInput2">نرخی فرۆشتن</label>
					<input type="text" value="0" name="sale_price"  class="form-control border-input" id="formGroupExampleInput2" required>
				</fieldset>

				<fieldset class="form-group">
				<label for="formGroupExampleInput2">گروپی کاڵا</label>
				...
				<fieldset class="form-group hidden">
					...
					<input type="text" name="status" value="1" class="form-control border-input" id="formGroupExampleInput2" >
				</fieldset>
