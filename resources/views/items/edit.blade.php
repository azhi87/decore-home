...
@include('layouts.errorMessages')
       ...
       <div class="panel panel-info">
		...
		<form class='text-right' method="POST" action="/items/update/{{$item->id}}" enctype="multipart/form-data" id="addForm">
			{{csrf_field()}}
			...
			<fieldset class="form-group">
				<label for="formGroupExampleInput2">جۆری کاڵا</label>
			...
			<fieldset class="form-group">
					...
					<input type="text" name="purchase_price" value="{{$item->purchase_price}}" class="form-control" id="formGroupExampleInput2">
			</fieldset>
			
			<fieldset class="form-group">
					<label for="formGroupExampleInput2">نرخی فرۆشتن</label>
					<input type="text" name="sale_price" value="{{$item->sale_price}}"  class="form-control" id="formGroupExampleInput2" required>
			</fieldset>
			...
			<fieldset class="form-group">
					...
					<input type="text" name="shewa" value="{{$item->shewa}}" class="form-control border-input" id="formGroupExampleInput2" >
			</fieldset>

			<fieldset class="form-group">
					<label for="formGroupExampleInput2">قوماش</label>
					<input type="text" name="qomash" value="{{$item->qomash}}" class="form-control border-input" id="formGroupExampleInput2" >
			</fieldset>

			<fieldset class="form-group">
					<label for="formGroupExampleInput2">چەرم</label>
					<input type="text" name="charm" value="{{$item->charm}}" class="form-control border-input" id="formGroupExampleInput2" >
			</fieldset>

			<fieldset class="form-group">
					<label for="formGroupExampleInput2">گۆشە</label>
					<input type="text" name="gozha" value="{{$item->gozha}}" class="form-control border-input" id="formGroupExampleInput2" >
			</fieldset>

			<fieldset class="form-group">
					<label for="formGroupExampleInput2">ڕەنگ</label>
					<input type="text" name="color" value="{{$item->color}}" class="form-control border-input" id="formGroupExampleInput2" >
			</fieldset>
