	...
	<div class="card well">
					...
					<form method="POST" action="/expenses/searchReason">
						...
						<div class="input-group has-warning">
							<span class="input-group-btn">
								<button class="btn btn-secondary btn-danger btn-fill"
									type="submit"><b>!گەڕان</b></button>
							</span>
					...
					<div class="col-md-3">
						<div class="input-group">
							<span class="input-group-btn">
								<button class="btn btn-secondary btn-danger btn-fill"
									type="submit"><b>!گەڕان</b></button>
								<button class="btn btn-secondary btn-success btn-fill" type="submit"
									name="excel"><b>!ئێکزڵ</b></button>
							</span>
		...
		?>
						...
						<tr class="text-center">
							...
							<td>{{number_format($expense->dinars,0)}}</span></td>
						...
						<form class='text-right' method="POST" action="/expenses/store" id="addForm">
							...
							<fieldset class="form-group has-warning">
								...
								<div class="input-group">
									...
									<input type="text" value="0" min="0" onkeyup="calculateTotalPaid(0)"
										onblur="calculateTotalPaid(0)" id="dinars" name="dinars" class="form-control"
										onchange="calculateDollars();" onkeyup="calculateDollars();" />
								</div>
							</fieldset>
							...
							<fieldset class="form-group has-warning">
								...
								<div class="input-group">
									...
									<input type="text" id="rate" value="{{$rate->rate}}" onkeyup="calculateTotalPaid(0)"
										onblur="calculateTotalPaid(0)" class="form-control"
							...
							<fieldset class="form-group has-warning">
								...
								<div class="input-group">
									<span class="input-group-addon">-</span>
									<input type="text" id="dollars" name="dollars" min="0" value="0"
										onchange="calculateDollars();" onkeyup="calculateDollars();"
							...
							<fieldset class="form-group has-warning">
								...
								<div class="input-group">
									<span class="input-group-addon">-</span>
									<input type="text" id="calculatedPaid" min="0" name="amount" class="form-control"
										required readonly="" />
								</div>
							</fieldset>
							...
							<fieldset class="form-group has-warning">
								...
								<div class="input-group">
									<span class="input-group-addon">-</span>
									<textarea type="text" name="note" cols="2" rows="2"
