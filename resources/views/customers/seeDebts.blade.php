...
<table class="table table-borderless ">
  ...
  <li class="dropdown">
  <button  class="dropdown-toggle btn btn-primary btn3d" data-toggle="dropdown"><span class="h4">قەرز بەپێی مەندوب <span class="caret"></span></span></button>
  ...
  @foreach ($mandwbs as $mandwb)
			...
			<th class="text-right color-red h3"><bd>{{number_format($debts->sum('dinars'),0)}}</bd></th>
