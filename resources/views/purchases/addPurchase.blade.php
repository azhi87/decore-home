    ...
    <div class="col-md-12">
        ...
        <div class="card" data-background-color="white">
            ...
            <div class="card-body text-right">
                <form action='/purchase/create' class='form-inline' id="purchaseFormValidation" novalidate=""
                    ...
                    <div class="alert bg-inverse">
                        ...
                        <div class="form-group input-group col-md-3 col-sm-4 col-xs-3">
                            <input readonly="readonly" required="true" aria-required="true" type="text" name="total"
                                id="total" class="form-control text-right border-input">
                            <span class="input-group-addon">نرخی گشتی</span>
                        </div>

                        <div class="form-group input-group col-md-3 col-sm-4 col-xs-3">
                            <select required="required" type="text" name="supplier_id"
                                class="form-control text-right border-input">
                    ...
                    <div class="alert bg-inverse">
                        <div class="form-group input-group col-md-2 col-sm-6 col-xs-6 ">
                            <input type="text" id="extra" value="0" onblur="getSaleTotalPrice();"
                                onkeyup="getSaleTotalPrice();" name="extra" class="form-control text-right border-input"
                                required>
                        ...
                        <div class="form-group input-group col-md-2 col-sm-6 col-xs-6">
                            <input value="0" required="true" aria-required="true" type="text" name="discount"
                                class="form-control text-right border-input">
                            <span class="input-group-addon">داشکاندن</span>
                        </div>

                        <div class="form-group input-group col-md-3 col-sm-6 col-xs-6">
                            <input required="true" aria-required="true" type="text" name="paid"
                                class="form-control  text-right border-input" required>
                    ...
                    <div class="row col-md-12" id="repeatedSale">
                        ...
                        <div class="form-group input-group col-md-6 col-sm-6 col-xs-6">
                            <input type="text" onblur="getSaleTotalPrice();" id="quantity0" value="1" name="quantity0"
                                class="form-control text-right">
                            <span class="input-group-addon">ژمارە</span>

                            <input type="text" onblur="getSaleTotalPrice();" name="sppi0" id="sppi0"
                                class="form-control text-right">
                            <span class="input-group-addon">ن.فرۆشتن</span>

                            <input type="text" onblur="getSaleTotalPrice();" name="ppi0" id="ppi0"
                                class="form-control text-right">
                        ...
                        <div class="form-group input-group col-md-4 col-sm-4 col-xs-4">
                            ...
                            <select id="barcode0" name="barcode0" onchange="getItemPurchasePrice(this.value,this.id);"
                                class="form-control slct2" style="min-width: 250px;text-align:center">
                                <option></option>
                                @foreach ($items as $item)
                                <option value="{{$item->id}}">{{$item->id}} -- {{$item->name}}</option>
                                @endforeach
                    ...
                    <div class="text-center no-print">
                        <input type="submit" name="submit" value="تۆمارکردن"
                            class="btn-danger text-center btn-lg btn3d" />
                    </div>
