    ...
    <div class="row">
        <div class="col-md-6 col-sm-8 col-md-offset-3 col-sm-offset-2">
            ...
            <div class="panel panel-success">
                <div class="panel-heading text-center"><span class="h3">زیادکردنی بەکارهێنەر</span></div>
                <div class="panel-body">
                    <form class="form-horizontal text-right" role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('branch_id') ? ' has-error' : '' }}">
                            <div class="col-md-6">
                                <select class="form-control" name="branch_id" required>
                                    <option value="1">لقی یەک</option>
                                    <option value="2">لقی دوو</option>
                                </select>
                            </div>
                            <label for="email" class="col-md-4 control-label">لق </label>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <label for="password-confirm" class="col-md-4 control-label">دوبارەکردنەوەی ووشەی
                                نهێنی</label>
                        </div>
