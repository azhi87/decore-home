...
<form method="POST" action="/reports/qistByDate" id="contact_form">
	{{csrf_field()}}
		...
		<div class="col-md-12">
	<button type="submit" name="boxes" class="btn btn-primary btn-block btn3d"><strong> کارتۆن</strong></button>
		</div>
		</div>
</form>
</div>
...
<form method="POST" action="/reports/due" id="contact_form">
	{{csrf_field()}}
		...
		<div class="col-md-12">
			...
			<button type="submit" name="submit" class="btn btn-primary btn-block btn3d"><strong>گەڕان</strong></button>
		</div>
	</div>
</form>
</div>
...
<form method="POST" action="/reports/stpSale" id="contact_form">
	{{csrf_field()}}
		...
		<div class="col-md-12">
		    ...
		    <div class="col-md-6">
			<button type="submit" name="purchase" class="btn btn-primary btn-block btn3d"><strong>کڕین</strong></button>
	</div>
	  <div class="col-md-6">
	
			<button type="submit" name="sale" class="btn btn-primary btn-block btn3d"><strong>فرۆشتن</strong></button>
		</div>
	</div>
</form>
</div>
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-xs-6">
                                          <div class="numbers text-center ">
                                            <p><b><a class=" text-center" style="color:inherit;" href="/reports/supplierDebt"> سەرجەمی قەرزی کۆمپانیاکان</a></b> </p>
