...
<div class=" row row-print bordered-2 text-center " >
    <br/>
    <p class="h3 color-black"><b>ڕاپۆرتی پارەی هاتوو</b></p> 
    <br/>
</div>

<div class="row bordered-1" >
<br>
    <table class="table table-borderless tfs20bold">
    <tbody  class="text-center">
      <tr>
            <td class="col-md-2 col-print-3 h4 text-right" class="bordersolid"><strong> {{$to}}</strong></td>
            <td class="col-md-2 col-print-2 h4 text-left" class="backcsilver"><strong>: بۆ بەرواری </strong></td> 
            <td class="col-md-2 col-print-3 h4 text-right" class="bordersolid"><strong> {{$from}}</strong></td>
            <td class="col-md-2 col-print-2 h4 text-left" class="backcsilver"><strong>: لە بەرواری </strong></td>
...
<div class="row text-center">
        ...
        <table class="table table-bordered table-striped table-text-center tfs20bold">
